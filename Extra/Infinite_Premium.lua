...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://pastefy.app/b052AUgc/raw'))()")
	end
end)
...
addcmd("datalimit", {}, function(args, speaker)
	...
	if kbps then Services.NetworkClient:SetOutgoingKBPSLimit(kbps) end
end)

addcmd("replicationlag", {"backtrack"}, function(args, speaker)
	if tonumber(args[1]) then settings():GetService("NetworkSettings").IncomingReplicationLag = args[1] end
end)
...
addcmd("explorer", {"dex"}, function(args, speaker)
   Notify_InfP("Loading", "Hold on a sec")
   loadstring(game:HttpGet("https://pastefy.app/XmD5kvrf/raw"))()
end)
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function() 
		local versionJson = game:HttpGet("https://pastebin.com/raw/VftYETes")
