    ...
    --[[local Module = loadstring(game:HttpGet('https://raw.githubusercontent.com/EnterpriseExperience/MicUpSource/refs/heads/main/module.lua'))() -- old module, still use it though to patch updates, destroy the GUI, etc, basic stuff.
    ...
    -- Keeps track of our version, dipshit. --
    ...
    if httprequest_loader and typeof(httprequest_loader) == "function" then
        response = httprequest_loader({
            Url = "https://pastebin.com/raw/tg4tu73Y",
            Method = "GET"
        })
    else
    ...
    if (getgenv().SCRIPT_EXECUTED == true) and (getgenv().All_TheWay_Loaded_FLAMES_HUB_GETGENV_VALUE == false) then
        ...
        task.wait(0.1)
        -- Destroy the current running script, as it most likely failed to run, don't right now. --
        --Module:Destroy_Script()
        task.wait(0.3)
        -- Then obviously just re-runs down here if the script failed a load last time. --
        loadstring(game:HttpGet("https://gitlab.com/greatest-group/experience_coding/-/raw/main/Extra/Universal.lua/refs?ref_type=heads"))()
    end
    wait(0.2)
    ...
    if getgenv().advanced_workaround_method == false and getmetatable and setmetatable and hookmetamethod and hookfunction then -- forgot why I had this lmfao.
        loadstring(game:HttpGet('https://pastebin.com/raw/ZcRzJhJL'))()
        wait(0.1)
    ...
    for attempt = 1, MAX_ATTEMPTS do
        local success, result = pcall(function()
            return loadstring(game:HttpGet("https://pastefy.app/oH3cwZUj/raw"))()
        end)
    ...
    local Flames_Module = loadstring(game:HttpGet('https://pastefy.app/ojpOf3tA/raw'))()
    getgenv().Module_For_Flames_Hub = Flames_Module
    if getgenv().AllClipboards then getgenv().AllClipboards("GitHub is currently de-activated because I switched providers due to their incompetence.") end
    wait()
    local Window 
    wait(0.2)
    ...
    getgenv().LocalPlayer.OnTeleport:Connect(function(State)
        if (not getgenv().TeleportCheck) and getgenv().queueteleport then
            ...
            queueteleport("loadstring(game:HttpGet(('https://gitlab.com/greatest-group/experience_coding/-/raw/main/Extra/Universal.lua/refs?ref_type=heads')))()")
        end
    end)
    wait(0.2)
    ...
    Callback = function()
        if getgenv().AllClipboards then
            getgenv().AllClipboards("GitHub is currently down.")
            getgenv().notify("Success", "Paste the link copied onto your browser to view all recent updates!", 5)
        else
            warn("GitHub is currently down.")
            getgenv().notify("Error", "Posted the link in Developer Console, couldn't copy.", 6)
        end
    end,})
    ...
    function check_r15()
        if getgenv().Humanoid.RigType == Enum.HumanoidRigType.R15 then
            ...
            return getgenv().notify("Error", "You do not seem to be R15.", 5)
        end
    end
    ...
    Callback = function(emote_picked)
        ...
        elseif not getgenv().Humanoid.RigType == Enum.HumanoidRigType.R15 then
            return getgenv().notify("Error", "You are not R15!", 5)
        end
    end,})
    wait(0.1)
    if game.PlaceId == 6884319169 or game.PlaceId == 15546218972 then
    ...
    local esplib = loadstring(game:HttpGet("https://pastebin.com/raw/RUkE575Z"))()
    ...
    --[[local Module = loadstring(game:HttpGet('https://raw.githubusercontent.com/EnterpriseExperience/MicUpSource/refs/heads/main/module.lua'))()
    wait(0.3)
    ...
    task.spawn(function()
        while getgenv().ConstantUpdate_Checker_Live do
            ...
            local success,data = pcall(function()
                local versionJson = game:HttpGet("https://raw.githubusercontent.com/dudeididntliterally/Backup_Repo/refs/heads/main/Script_Versions_JSON.json")
